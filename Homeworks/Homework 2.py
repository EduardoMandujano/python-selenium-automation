...
# driver = webdriver.Chrome(executable_path='/Users/eduar/Automation/13-python-selenium-automation/chromedriver')
service = Service('/Users/eduar/Automation/13-python-selenium-automation/chromedriver')
